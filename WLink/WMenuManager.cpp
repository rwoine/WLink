...
void InitMenuItem(void) {
    ...
    for (int i = 0; i < WMENU_ITEM_NUMBER; i++) {
		...
		GL_pWMenuItem_X[i].Id_E = WMENU_ITEM_NULL;
	...
	GL_pWMenuItem_X[WMENU_ITEM_WELCOME_SCREEN].Id_E = WMENU_ITEM_WELCOME_SCREEN;
	...
	GL_pWMenuItem_X[WMENU_ITEM_IDLE_SCREEN].Id_E = WMENU_ITEM_IDLE_SCREEN;
	...
	GL_pWMenuItem_X[WMENU_ITEM_SETTINGS].Id_E = WMENU_ITEM_SETTINGS;
	...
	GL_pWMenuItem_X[WMENU_ITEM_SETTINGS_LANGUAGE].Id_E = WMENU_ITEM_SETTINGS_LANGUAGE;
	...
	GL_pWMenuItem_X[WMENU_ITEM_SETTINGS_LANGUAGE_SELECT].Id_E = WMENU_ITEM_SETTINGS_LANGUAGE_SELECT;
	...
	GL_pWMenuItem_X[WMENU_ITEM_SETTINGS_DATETIME].Id_E = WMENU_ITEM_SETTINGS_DATETIME;
	...
	GL_pWMenuItem_X[WMENU_ITEM_SETTINGS_DATETIME_DATE].Id_E = WMENU_ITEM_SETTINGS_DATETIME_DATE;
	...
	GL_pWMenuItem_X[WMENU_ITEM_SETTINGS_DATETIME_DATE_SET].Id_E = WMENU_ITEM_SETTINGS_DATETIME_DATE_SET;
	...
	GL_pWMenuItem_X[WMENU_ITEM_SETTINGS_DATETIME_TIME].Id_E = WMENU_ITEM_SETTINGS_DATETIME_TIME;
	...
	GL_pWMenuItem_X[WMENU_ITEM_SETTINGS_DATETIME_TIME_SET].Id_E = WMENU_ITEM_SETTINGS_DATETIME_TIME_SET;
	...
	GL_pWMenuItem_X[WMENU_ITEM_SETTINGS_LCD].Id_E = WMENU_ITEM_SETTINGS_LCD;
	...
	GL_pWMenuItem_X[WMENU_ITEM_SETTINGS_LCD_BACKLIGHT].Id_E = WMENU_ITEM_SETTINGS_LCD_BACKLIGHT;
